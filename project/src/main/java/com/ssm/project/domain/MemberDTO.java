...
public class MemberDTO {
	...
	// 추가 : MemberVO(sql.Date) -> MemberDTO(util.Date)형변환
	public MemberDTO(MemberVO memberVO) {
		...
		this.memberBirth = new java.sql.Date(memberVO.getMemberBirth().getTime());
		...
		this.memberJoinDate = new java.sql.Date(memberVO.getMemberJoinDate().getTime());
	}
