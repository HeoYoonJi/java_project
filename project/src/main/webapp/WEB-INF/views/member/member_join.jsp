...
<!--  modal -->
<link rel="stylesheet" href="${contextPath}/css/custom/modal.css">

<!-- 회원가입 CSS -->
<link rel="stylesheet" href="${contextPath}/css/custom/member_join.css">

<!-- daum 주소 검색 -->
<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script>

<!-- jquery -->
<script src="${contextPath}/js/jquery/jquery-3.5.1.min.js"></script>
  
<!-- jqueryui -->  
<link rel="stylesheet" href="${contextPath}/webjars/jquery-ui/themes/base/jquery-ui.min.css">
...
<script src="${contextPath}/js/custom/member_join.js" charset="UTF-8"></script>
	...
	<div id="join_wrap">
	    ...
	    <div id="joinFormPnl">
		    ...
		    <form id="joinForm" 
		    	  name="joinForm" 
		          method="post"
		          action="${contextPath}/member/joinProc.do">
